...
protected:
    ...
    void SetUp() override {
        ...
        if (inType == ElementType::u8)
            ...
            fq1 = ngraph::builder::makeFakeQuantize(inputParams[0],
                                                    ngPrec,
                                                    256,
                                                    {},
                                                    {-1.28f},
        ...
        if (isFC) {
            ...
            auto fq2 =
                ngraph::builder::makeFakeQuantize(weightsNode, ngPrec, 256, {}, {-1.28f}, {1.27f}, {-1.28f}, {1.27f});
            ...
            auto fq2 = ngraph::builder::makeFakeQuantize(inputParams[0],
                                                         ngPrec,
                                                         256,
                                                         {},
                                                         {-1.28f},
        ...
        if (outType == ElementType::u8)
            nodeBeforeConv =
                ngraph::builder::makeFakeQuantize(matMul, ngPrec, 256, {}, {0.0f}, {2.55f}, {0.0f}, {2.55f});
        else if (outType == ElementType::i8)
            nodeBeforeConv =
                ngraph::builder::makeFakeQuantize(matMul, ngPrec, 256, {}, {-1.28f}, {1.27f}, {-1.28f}, {1.27f});
        else
        ...
        auto filterWeightsNode =
            ngraph::builder::makeConstant(element::f32, filterWeightsShape, std::vector<float>{}, true);
        auto fq3 =
            ngraph::builder::makeFakeQuantize(filterWeightsNode, ngPrec, 256, {}, {-1.28f}, {1.27f}, {-1.28f}, {1.27f});
